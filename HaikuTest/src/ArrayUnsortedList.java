...
//	                reset
	...
	public void addRear(Pair element) 
	// Adds element to the end of this list.
	{
		T listElement;       
		int location = (list.length - 1);
	...
	public void addRear(ArrayUnsortedList<T> arrayToAdd) 
	// Adds element to the end of this list.
	{
		T listElement;       
		int location = (list.length - 1);
		...
		{
			listElement = (T) list[location] ;
			if (((Comparable) listElement).compareTo(arrayToAdd)  < 0) 
		// list element < add element
				location--;
			else
				break;    // list element >= add element
